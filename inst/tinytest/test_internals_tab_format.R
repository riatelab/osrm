...
# tab_format_out_dist <- osrm:::tab_format(res = tab_format_in,
#                                     src = tab_format_in$src,
#                                     dst = tab_format_in$dst,
#                                     type = "distance")
# tab_format_out_dur <- osrm:::tab_format(res = tab_format_in,
#                                          src = tab_format_in$src,
#                                          dst = tab_format_in$dst,
#                                          type = "duration")
...
expect_identical(osrm:::tab_format(res = tab_format_in, 
                                   src = tab_format_in$src, 
                                   dst = tab_format_in$dst, 
                                   type = "duration"), 
