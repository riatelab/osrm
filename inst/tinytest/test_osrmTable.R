...
if(local_server){
  ...
  expect_equal(unname(diag(A$total_distances)), rep(0, 5))
  ...
  expect_equivalent(B$total_distances[1,2], 
               B$distances[1,2] + B$sources$snapping_distance[1] + 
                 B$destinations$snapping_distance[2], .1)
}